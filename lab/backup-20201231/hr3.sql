...
CREATE TABLE IF NOT EXISTS `EMPLOYEES` (
  ...
  `SALARY` double(22,2) DEFAULT NULL COMMENT 'Monthly salary of the employee. Must be greater than zero (enforced by constraint emp_salary_min)',
...
(203, 'Susan', 'Mavris', 'SMAVRIS', '515.123.7777', '1994-06-07', 'REP', 6500, NULL, 101, 40),
